...
|----------|------|---------|
| **Notify Release** | [`.github/workflows/notify-release/notify-release.yml`](.github/workflows/notify-release/notify-release.yml) ([docs](.github/workflows/notify-release/README.md)) | Post a Slack notification when a release is published, including a compare link to the previous release |
